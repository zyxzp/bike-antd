...
export default class City extends React.Component {
    ...
    handleQuery = () => {
        ...
        message.info('query param :' + JSON.stringify(queryInfo));
        // this.request();
    }
    //打开开通城市对话框
    handleOpenCity = () => {
    ...
    handleSubmit = () => {
        ...
        message.info(JSON.stringify(cityInfo));
        this.setState({
            isShowOpenCity: false
        })
        this.request();
    ...
    render() {
        ...
        return (
            <Form layout="inline">
                ...
                <FormItem>
                    <Button type="primary" style={{ margin: '0 20px' }} onClick={this.props.handleQuery} > 查询</Button>
